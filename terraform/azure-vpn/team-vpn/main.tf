# team-vpn — Azure OpenVPN endpoint in eastus
...
resource "azurerm_linux_virtual_machine" "vpn" {
  ...
  admin_ssh_key {
    username   = "azureuser"
    public_key = "ssh-rsa  team-vpn-azure-vpn-admin"
  }
