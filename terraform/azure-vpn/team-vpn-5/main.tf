# team-vpn-5 — Azure OpenVPN endpoint in eastus
# split-tunnel · UDP/1194 · client CIDR 10.100.0.0/22
# Attaches to VNet vpc-ai-net / subnet default in RG rg-devops.
...
resource "azurerm_linux_virtual_machine" "vpn" {
  ...
  admin_ssh_key {
    username   = "azureuser"
    public_key = "ssh-rsa  team-vpn-5-azure-vpn-admin"
  }
